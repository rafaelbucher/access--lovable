    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-16">
        <div className="max-w-4xl space-y-12">
          ...
          <section>
            <h2 className="text-3xl md:text-6xl font-display font-bold mb-6">Nos valeurs</h2>
          ...
          <section>
            <h2 className="text-3xl md:text-6xl font-display font-bold mb-6">Notre expertise</h2>
          ...
          <section className="bg-accent p-8 border-2 border-foreground">
            <h2 className="text-3xl md:text-6xl font-display font-bold mb-6">Coordonnées</h2>
